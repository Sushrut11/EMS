...
<div class="flex justify-center items-center min-h-screen">
    <form name="frmEditPublicHoliday" action="http://localhost:8080/payrollsystem/UpdatePublicHolidayServlet" method="get" class="bg-white p-8 rounded-lg shadow-lg w-full max-w-lg">
        ...
        <table class="border border-gray-200 w-full">
            <tr>
                ...
                <td class="p-3"><input type="text" name="txtPublicHolidayId" id="txtPublicHolidayId" value="<%=pdto.getPhId()%>" class="border border-gray-300 rounded-md px-3 py-2 w-full"></td>
            </tr>
            <tr>
                <td class="p-3 font-semibold">Public Holiday Name</td>
                <td class="p-3"><input type="text" name="txtPublicHolidayName" id="txtPublicHolidayName" value="<%=pdto.getPhName()%>" class="border border-gray-300 rounded-md px-3 py-2 w-full"></td>
            </tr>
            <tr>
                <td class="p-3 font-semibold">Public Holiday Description</td>
                <td class="p-3"><input type="text" name="txtPublicHolidayDesc" id="txtPublicHolidayDesc" value="<%=pdto.getPhDescription()%>" class="border border-gray-300 rounded-md px-3 py-2 w-full"></td>
            </tr>
        </table>
        <div class="mt-8 flex justify-center">
            ...
            <a href="http://localhost:8080/payrollsystem/PublicHoliday_Main.jsp" class="ml-4 inline-flex items-center px-6 py-3 border border-transparent text-sm font-medium rounded-md text-gray-700 bg-gray-200 hover:bg-gray-300 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-500">Back</a>
        </div>
    </form>
</div>
