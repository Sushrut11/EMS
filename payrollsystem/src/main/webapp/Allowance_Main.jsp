        ...
        <table class="w-full bg-white bg-opacity-30 rounded-lg overflow-hidden shadow-lg">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td class="px-4 py-2 text-center"><a href="http://localhost:8080/payrollsystem/Allowance_View.jsp?allowanceId=<%=adto.getAllowanceId()%>" class="text-blue-500 hover:text-blue-700">View</a></td>
                    <td class="px-4 py-2 text-center"><a href="http://localhost:8080/payrollsystem/Allowance_Update.jsp?allowanceId=<%=adto.getAllowanceId()%>" class="text-blue-500 hover:text-blue-700">Edit</a></td>
                    <td class="px-4 py-2 text-center"><a href="http://localhost:8080/payrollsystem/Allowance_Delete.jsp?allowanceId=<%=adto.getAllowanceId()%>" class="text-blue-500 hover:text-blue-700">Delete</a></td>
                </tr>
                <% } %>
            </tbody>
        </table>
